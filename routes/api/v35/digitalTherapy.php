...
Route::post('realTimeUIElementData/{user}', [
    'as'         => '.realTimeUIElementData',
    'uses'       => 'DigitalTherapyController@realTimeUIElementData',
    'middleware' => ['cronofyAuthenticate'],
]);

Route::post('createEventSlotDT/{user}', [
    'as'         => '.createEventSlotDT',
    'uses'       => 'DigitalTherapyController@createEventSlotDT',
    'middleware' => ['cronofyAuthenticate'],
]);

Route::post('cronofyException', [
    'as'         => '.cronofyException',
    'uses'       => 'DigitalTherapyController@cronofyException',
]);