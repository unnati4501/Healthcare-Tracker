...
Route::put('/favourite-unfavourite/{feed}', [
    'as'   => '.favourite-unfavourite',
    'uses' => 'FeedController@favouriteUnfavouriteFeed',
]);

Route::get('more-stories/{authorId}', [
    'as'   => '.more-stories',
    'uses' => 'FeedController@moreStories',
]);
