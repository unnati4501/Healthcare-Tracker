...
Route::post('/personal/update/{personalChallenge}', [
    'as'   => '.update',
    'uses' => 'PersonalChallengeController@update',
]);

Route::delete('/personal/delete/{personalChallenge}', [
    'as'   => '.delete',
    'uses' => 'PersonalChallengeController@delete',
]);

Route::get('/personalhistory/{personalChallenge}/{personalChallengeUser?}', [
    'as'   => '.personalhistory',
    'uses' => 'PersonalChallengeController@historyDetails',
]);
