...
Route::get('recent-masterclasses', [
    'as'   => '.recent-masterclasses',
    'uses' => 'MasterClassController@recentMasterClasses',
]);

Route::put('/favourite-unfavourite-masterclass/{course}', [
    'as'   => '.favourite-unfavourite-masterclass',
    'uses' => 'MasterClassController@favouriteUnfavouriteMasterclass',
]);
