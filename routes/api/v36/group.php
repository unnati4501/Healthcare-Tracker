...
Route::get('/details/{group}', [
    'as'   => '.details',
    'uses' => 'GroupController@groupDetails',
]);
...
Route::get('/company-members', [
    'as'   => '.company-members',
    'uses' => 'GroupController@companyMembers',
]);

Route::post('/accept-invitation/{group}', [
    'as'   => '.accept-invitation',
    'uses' => 'GroupController@acceptInvitation',
]);

Route::post('/decline-invitation/{group}', [
    'as'   => '.decline-invitation',
    'uses' => 'GroupController@declineInvitation',
]);
