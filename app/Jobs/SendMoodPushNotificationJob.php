...
class SendMoodPushNotificationJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($this->string == 'mood') {
            $title   = trans('notifications.survey.mood.title');
            $message = trans('notifications.survey.mood.message', [
                'first_name' => $this->user->first_name,
            ]);

            $deep_link_uri = "zevolife://zevo/moods";
        }
        ...
        $notificationData = [
            ...
            'is_mobile'        => config('notification.moods.is_mobile'),
            'is_portal'        => config('notification.moods.is_portal'),
            'tag'              => 'mood',
        ] + $extraNotificationData;
