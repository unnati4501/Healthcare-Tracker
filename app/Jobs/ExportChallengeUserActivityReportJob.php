...
class ExportChallengeUserActivityReportJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $fileName = 'challenge_user_activity_report_' . $dateTimeString . '.xlsx';
            ...
            if ($uploaded) {
                event(new ChallengeUserActivityReportExportEvent($this->email, $this->user, $url, $fileName));
                return true;
            }
