...
class SendDailyReminderPersonalChallenge extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'personalchallenge:dailyreminder';
    ...
    public function handle()
    {
        ...
        try {
            ...
            PersonalChallengeUser::select('personal_challenge_users.*')
                ...
                ->whereRaw("
                    DATE(CONVERT_TZ(personal_challenge_users.start_date, ?, users.timezone)) <= DATE(CONVERT_TZ(?, ?, users.timezone))
