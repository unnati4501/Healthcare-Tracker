...
class FreezeDataForRunningChallenge extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'challenge:freezedata {challengeId}';
     ...
     * @var string
     */
    protected $description = 'freeze challenge data while challenge is ongoing.';
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $challengeId = $this->argument('challengeId');

            // rolled out to company for confirmation
