...
class RealtimeAvailabilityEmail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function build()
    {
        try {
            ...
            $subject = "Realtime Availability Report";
            $reportName = "Realtime Availability";
            ...
            $mailSend = $this->from($address, $name)
                ...
                ->view('emails.realtime-report', $data)
