...
class BookingReportCompanyWiseExportEmail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function build()
    {
        try {
            ...
            $subject = "Booking Report Company Wise";
            $reportName = "company wise booking details";
