...
class BookingReportDetailExportEmail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function build()
    {
        try {
            ...
            if ($this->payload['tab']=='booking-details') {
                $subject = "Booking Report Details";
                $reportName = "booking details";
            } else {
                $subject = "Booking Report Summary";
