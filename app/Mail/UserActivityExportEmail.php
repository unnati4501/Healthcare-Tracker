...
class UserActivityExportEmail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function build()
    {
        try {
            ...
            if ($this->payload['tab']=='steps') {
                $subject = "User Steps Summary";
                $reportName = "user steps";
            } elseif ($this->payload['tab']=='exercise') {
                $subject = "User Exercise Summary";
                $reportName = "user exercise";
            } else {
                $subject = "User Meditation Summary";
                $reportName = "meditation summary";
            }
