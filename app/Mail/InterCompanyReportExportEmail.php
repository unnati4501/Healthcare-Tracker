...
class InterCompanyReportExportEmail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function build()
    {
        try {
            ...
            if ($this->payload['tab']=='ic-company') {
                $subject = "Intercompany Report";
                $reportName = "intercompany";
            } else {
                $subject = "Intercompany Team Report";
                $reportName = "intercompany team";
            }
