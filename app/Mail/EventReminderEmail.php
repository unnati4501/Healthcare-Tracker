    ...
    public function build()
    {
        if (!is_null($this->user) &&
            ...
            $dataArray = [
                ...
                'subject'             => (!empty($this->data['subject']) ? $this->data['subject'] : " "),
                ...
                'bookingDate'         => Carbon::parse($this->data['bookingDate'])->format('M d, Y'),
                'eventStartTime'      => Carbon::parse($this->data['bookingDate'])->format('h:i A'),
                'duration'            => $this->data['duration'],
                'presenter'           => $this->data['presenterName'],
            ...
            return $this
                ...
                ->view('emails.eventreminder', $dataArray);
        }
    }
}
