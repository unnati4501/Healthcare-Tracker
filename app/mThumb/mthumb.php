...
if (!class_exists('MThumb')) {
    ...
    class MThumb
    {
        ...
        public function __construct()
        {
            ...
            // -- Commented this block by maulik to avoid hotlinkers -- //
        ...
        {
            if (empty($localImage) || !file_exists($localImage)) {
                return $this->error("Failed to open error.");
            }
            ...
            if ($zoom_crop > 0) {
                ...
                imagecopyresampled($canvas, $image, (int) $origin_x, (int) $origin_y, (int) $src_x, (int) $src_y, (int) $new_width, (int) $new_height, (int) $src_w, (int) $src_h);
            } else {
            ...
            $fp        = fopen($tempfile, 'r', (bool) 0, $context);
        ...
        protected function getURL($url, $tempfile)
        {
            ...
            if (function_exists('curl_init')) {
                ...
                curl_setopt($curl, CURLOPT_WRITEFUNCTION, 'App\mthumb\mthumb::curlWrite');
