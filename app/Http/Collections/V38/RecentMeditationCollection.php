...
use App\Http\Resources\V38\RecentMeditationResource;
...
class RecentMeditationCollection extends ResourceCollection
{
    ...
    {
        if (!$this->pagination) {
            return RecentMeditationResource::collection($this->collection);
        } else {
            return [
                'data'       => RecentMeditationResource::collection($this->collection),
