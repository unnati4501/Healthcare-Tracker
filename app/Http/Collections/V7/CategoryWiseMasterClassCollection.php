...
namespace App\Http\Collections\V7;

use App\Http\Resources\V7\CategoryWiseMasterClassResource;
...
class CategoryWiseMasterClassCollection extends ResourceCollection
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'totalEnrolledMasterclasses'      => $this->when($this->totalEnrolledMasterclasses, $this->totalEnrolledMasterclasses),
