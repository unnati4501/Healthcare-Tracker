...
class EditCourseLessionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'audio'                   => "sometimes|nullable|mimetypes:audio/mpeg,audio/mp3,audio/m4a,audio/x-m4a|max:{$audioMax}",
            'audio_background'        => [
                "sometimes",
                "nullable",
                "image",
            ...
            'video'                   => "sometimes|nullable|mimetypes:video/mp4|max:{$videoMax}",
