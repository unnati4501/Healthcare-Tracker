...
class CreateRecipeRequest extends FormRequest
{
    ...
    {
        return access()->allow('create-recipe');
    }
    ...
    public function rules()
    {
        ...
        $rules['image.*']                 = "image|mimes:jpg,jpeg,png|max:{$logoMax}|filecount:image,3";
    ...
    public function messages(): array
    {
        ...
        $messages['header_image.dimensions']    = 'The uploaded image does not match the given dimension and ratio.';
        return $messages;
    }
