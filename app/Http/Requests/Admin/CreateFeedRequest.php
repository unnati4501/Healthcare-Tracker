...
class CreateFeedRequest extends FormRequest
{
    ...
    {
        return access()->allow('create-story');
    }
    ...
    public function rules()
    {
        ...
        $rules['feed_type']    = 'required';
        $rules['audio']        = "required_if:feed_type,1|nullable|mimetypes:audio/mpeg,audio/mp3,audio/m4a,audio/x-m4a|max:{$audioMax}";
    ...
    public function messages(): array
    {
        return [
            ...
            'header_image.required_if'            => 'The :attribute field is required',
