...
class CreateSlideRequest extends FormRequest
{
    ...
    {
        return access()->allow('create-onboarding');
    }
    ...
    public function rules()
    {
        ...
        $rules['slideImage'] = [
            'required',
            'required_if:type,eap',
            'image',
            'mimes:jpg,jpeg,png',
            "max:{$slideImageMax}"
        ];
        $rules['portalSlideImage'] = [
            'required_if:type,eap',
            'image',
            'mimes:jpg,jpeg,png',
            "max:{$slideImageMax}"
    ...
    public function messages(): array
    {
        return [
            ...
            'slideImage.required'               => 'The :attribute field is required',
            'slideImage.required_if'            => 'The mobile image field is required.',
            'portalSlideImage.required_if'      => 'The portal image field is required.',
        ];
    }
}
