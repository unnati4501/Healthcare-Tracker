...
/**
 * Class CreatePersonalChallengeRequest
 *
...
class CreatePersonalChallengeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules['reminderAt']     = 'required_if:frequencyType,daily';
        $rules['isRecursive']    = 'required|in:true,false';
        $rules['recursiveCount'] = 'integer';
        $rules['imageId']        = 'required_without:logo|integer|nullable|exists:challenge_image_library,id';
        $rules['frequencyType']  = 'required';
        $rules['endDate']        = 'required_if:challengetype,habit';
        $rules['fromTime']       = 'required_if:frequencyType,hourly';
        $rules['toTime']         = 'required_if:frequencyType,hourly';
        $rules['inEvery']        = 'required_if:frequencyType,hourly';
