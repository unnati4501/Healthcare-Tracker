...
use App\Http\Collections\V9\CategoryWiseTrackCollection;
use App\Http\Controllers\API\V8\MeditationController as v8MeditationController;
...
use App\Http\Resources\V9\CategoryWiseTrackResource;

class MeditationController extends v8MeditationController
{
