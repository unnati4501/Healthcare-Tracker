...
use App\Http\Controllers\API\V33\FeedController as v33FeedController;
use App\Http\Traits\ProvidesAuthGuardTrait;
use App\Http\Traits\ServesApiTrait;
use App\Models\Feed;
use Illuminate\Http\Request;

class FeedController extends v33FeedController
{
        ...
        try {
            ...
            if (!empty($pivotExsisting)) {
                ...
                if ($liked == 1) {
                    ...
                    $extraPoint = !is_null($feed->tag_id) ;
                    UpdatePointContentActivities('feed', $feed->id, $user->id, 'like', false, $extraPoint);
