...
use App\Http\Collections\V22\EAPSessionCollection;
use App\Http\Controllers\API\V21\CounsellorController as v21CounsellorController;
use App\Http\Resources\V22\EAPSessionDetailsResource;
...
class CounsellorController extends v21CounsellorController
{
    /**
        ...
        try {
            ...
            $showHistory = $user->bookedSessions()
                ->where(function ($query) use ($currentTime) {
                    ...
                    $query->orWhere(function ($subQuery) use ($currentTime) {
                        $subQuery
