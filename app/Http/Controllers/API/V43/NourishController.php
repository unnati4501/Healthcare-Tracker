...
use App\Http\Controllers\API\V1\NourishController as v1NourishController;
use App\Http\Requests\Api\V1\GetLogWeightRequest;
use App\Http\Requests\Api\V1\GetWeightRequest;
use App\Http\Resources\V43\NourishDataResource;
...
class NourishController extends v1NourishController
{
