...
use App\Http\Controllers\API\V4\FeedController as v4FeedController;
use App\Http\Resources\V5\FeedResource;
...
class FeedController extends v4FeedController
{
    ...
    {
        try {
            return $this->successResponse(['data' => new FeedResource($feed, 'details')], 'Feed details retrived successfully');
        } catch (\Exception $e) {
            report($e);
            return $this->internalErrorResponse(trans('labels.common_title.something_wrong'));
        }
