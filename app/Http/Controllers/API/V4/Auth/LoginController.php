...
use App\Http\Collections\V4\AppSettingCollection;
use App\Http\Controllers\API\V3\Auth\LoginController as v3LoginController;
 ...
 */
class LoginController extends v3LoginController
{
