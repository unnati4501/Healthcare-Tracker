...
use App\Http\Controllers\API\V31\CommonController as v31CommonController;
...
class CommonController extends v31CommonController
{
        ...
        try {
            ...
            if (!empty($modelData)) {
                ...
                if (in_array($modelType, ['feed', 'recipe'])) {
                    UpdatePointContentActivities($modelType, $id, $user->id, 'open');
                }
            ...
            if (!empty($groupIds)) {
                if (!empty($model)) {
                    ...
                    if (in_array($request->modelType, ['feed', 'masterclass', 'meditation', 'webinar', 'recipe'])) {
                        UpdatePointContentActivities($request->modelType, $model->id, $user->id, 'share');
                    }
