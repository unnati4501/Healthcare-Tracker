...
use App\Http\Controllers\API\V31\MasterClassController as v31MasterClassController;
...
class MasterClassController extends v31MasterClassController
{
    ...
    public function submitMasterClassSurvey(Request $request, CourseSurvey $survey)
    {
        try {
            ...
            if ($survey->type == "pre") {
                ...
                UpdatePointContentActivities('masterclass', $course->id, $user->id, 'begin_survey');
                ...
                UpdatePointContentActivities('masterclass', $course->id, $user->id, 'end_survey');
    ...
    public function likeUnlikeMasterClass(Request $request, Course $course)
    {
        try {
            ...
            if (!empty($pivotExsisting)) {
                ...
                $pivotExsisting->pivot->save();
                UpdatePointContentActivities('masterclass', $course->id, $user->id, 'like');
                if ($liked == 1) {
