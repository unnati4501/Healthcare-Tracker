...
use App\Http\Controllers\API\V4\MeditationController as v4MeditationController;
use App\Http\Resources\V6\CategoryWiseTrackResource;
...
class MeditationController extends v4MeditationController
{
    /**
