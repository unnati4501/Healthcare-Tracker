...
use App\Http\Collections\V38\DigitalCounsellorListCollection;
use App\Http\Controllers\API\V38\DigitalTherapyController as v38DigitalTherapyController;
 ...
 */
class DigitalTherapyController extends v38DigitalTherapyController
{
        ...
        try {
            ...
            if (!empty($request->lang)) {
                $getWellbeingSpecialist = $getWellbeingSpecialist->where('users_services.service_id', $serviceSubCategory->id)
                    ->whereRaw('FIND_IN_SET(?, ws_user.language)', [$request->lang]);
            }
