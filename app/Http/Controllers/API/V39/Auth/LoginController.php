...
use App\Http\Controllers\API\V38\Auth\LoginController as v38LoginController;
 ...
 */
class LoginController extends v38LoginController
{
    ...
    public function sendSingleUseCode(EmailRequest $request, $fromApi = 'login')
    {
        try {
            ...
            if($userOtpExists->count() > 3){
                UserOtp::where('email', $user->email)->orderBy('id', 'ASC')->limit(1)->delete();
            }
