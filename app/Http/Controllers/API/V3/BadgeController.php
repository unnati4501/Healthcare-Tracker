...
use App\Http\Controllers\API\V1\BadgeController as v1BadgeController;
use App\Http\Collections\V3\UserBadgeDetailsListCollection;
use App\Http\Controllers\Controller;
use App\Http\Resources\V3\UserBadgeDetailsResource;
...
class BadgeController extends v1BadgeController
{
