...
use App\Http\Controllers\API\V16\CommonController as v16CommonController;
...
class CommonController extends v16CommonController
{
        ...
        try {
            ...
            if ($category->short_name == 'meditation') {
                ...
                if ($xDeviceOs == config('zevolifesettings.PORTAL')) {
                    ...
                    if ($favouritedCount > 0) {
                        $records = array(-1 => "All") + array(0 => "My ❤️") + $subcategoryRecords;
                    } else {
                        $records = array(-1 => "All") + $subcategoryRecords + array(0 => "My ❤️");
                    }
                }
