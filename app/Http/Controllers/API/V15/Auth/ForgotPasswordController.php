...
namespace App\Http\Controllers\Api\V15\Auth;

use App\Events\UserForgotPasswordEvent;
use App\Http\Controllers\API\V12\Auth\ForgotPasswordController as v12ForgotPasswordController;
 ...
 */
class ForgotPasswordController extends v12ForgotPasswordController
{
    use ServesApiTrait;
    ...
    public function sendResetLinkEmail(ForgotPasswordRequest $request)
    {
        try {
            ...
            if ($user) {
                // Thorws same message when user not in system or in system.
            ...
            return $this->successResponse([], 'You will receive an email with the instructions to reset your password if your Email ID is registered with us.');
        } catch (\Exception $e) {
            report($e);
