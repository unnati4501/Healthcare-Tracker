...
use App\Http\Controllers\API\V11\Auth\ForgotPasswordController as v11ForgotPasswordController;
 ...
 */
class ForgotPasswordController extends v11ForgotPasswordController
{
    use ServesApiTrait;
    ...
    public function sendResetLinkEmail(ForgotPasswordRequest $request)
    {
        try {
            ...
            if ($user) { // Thorws same message when user not in system or in system.
            ...
            return $this->successResponse([], 'You will receive an email if you are registered with system.');
        } catch (\Exception $e) {
            report($e);
