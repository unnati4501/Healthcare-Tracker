...
use App\Http\Collections\V12\NotificationCollection;
use App\Http\Controllers\API\V6\NotificationController as v6NotificationController;
...
class NotificationController extends v6NotificationController
{
