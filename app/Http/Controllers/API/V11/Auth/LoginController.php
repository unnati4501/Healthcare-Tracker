...
use App\Http\Collections\V11\AppSettingCollection;
use App\Http\Controllers\API\V10\Auth\LoginController as v10LoginController;
use App\Http\Controllers\Controller;
use App\Http\Requests\Api\V1\LoginRequest;
use App\Http\Resources\V11\UserResource;
 ...
 */
class LoginController extends v10LoginController
{
    ...
    public function attemptLogin(Request $request)
    {
        if (!empty($request->get('email')) && !empty($request->get('socialId'))) {
            ...
            if ($xDeviceOs == config('zevolifesettings.PORTAL')) {
                return $this->guard()->attempt($this->credentials($request), ['exp' => Carbon::now()->addHours(2)->timestamp]);
            } else {
