...
use App\Http\Controllers\API\V7\FeedController as v7FeedController;
use App\Http\Resources\V11\FeedResource;
...
class FeedController extends v7FeedController
{
