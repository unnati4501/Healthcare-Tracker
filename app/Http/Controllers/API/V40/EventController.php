...
use App\Http\Controllers\API\V39\EventController as v39EventController;
...
class EventController extends v39EventController
{
    /**
        ...
        try {
            ...
            if (is_null($checkAlreadyRegisterd)) {
                ...
                $userDate = Carbon::parse("{$eventbookinglogs->booking_date} {$eventbookinglogs->start_time}", $appTimezone)
                    ->setTimezone($eventbookinglogs->timezone);
                ...
                dispatch(new SendEventBookedEamilJob($email, [
                    ...
                    'timezone'      => $eventbookinglogs->timezone,
        ...
        try {
            ...
            if ($checkAlreadyRegisterd) {
                ...
                if (!$cancelledStatus) {
                    ...
                    $displayStartTime = Carbon::parse("{$eventbookinglogs->booking_date} {$eventbookinglogs->start_time}", $appTimezone)->setTimezone($eventbookinglogs->timezone)->format('M d, Y h:i A');
