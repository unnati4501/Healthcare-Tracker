...
use App\Http\Controllers\API\V30\RecipeController as v30RecipeController;
...
class RecipeController extends v30RecipeController
{
    /**
    ...
    public function recipeStaticData(Request $request)
    {
        try {
            ...
            $data = [
                ...
                'protein'       => [
                    'min'  => (int) 0,
                    'max'  => (int) (empty($recipeFilterData->max_protein) ? 1 : floor((int)$recipeFilterData->max_protein)),
