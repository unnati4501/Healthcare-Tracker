...
use App\Http\Collections\V24\MyGroupListCollection;
use App\Http\Controllers\API\V22\GroupController as v22GroupController;
...
class GroupController extends v22GroupController
{
    /**
     * Get group list
     *
