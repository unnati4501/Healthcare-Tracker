...
use App\Http\Controllers\API\V35\DigitalTherapyController as v35DigitalTherapyController;
 ...
 */
class DigitalTherapyController extends v35DigitalTherapyController
{
    ...
    public function realTimeUIElementData(Request $request, User $user)
    {
        ...
        try {
            ...
            if (!empty($digitalTherapyDetails)) {
                ...
                if (($setHoursBy == 2 && $setAvailabilityBy == 1) || ($setHoursBy == 1 && $setAvailabilityBy == 1)) { // Location - General And Company - General
                ...
                } else if (($setHoursBy == 2 && $setAvailabilityBy == 2) || ($setHoursBy == 1 && $setAvailabilityBy == 2)) {  // Location - Specific And Company - Specific
