...
class FinishedChallengeDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if (!empty($this->freezed_data_at) && !$isCompleted) {
            $description .= "<br/><br/><b>Last points updated at " . Carbon::parse($this->freezed_data_at, $appTimezone)->setTimezone($userTimezone)->format('d/m/Y h:i A') . "<br/><br/>Next points update will be on " . Carbon::parse($this->freezed_data_at, $appTimezone)->setTimezone($userTimezone)->addHours(4)->format('d/m/Y h:i A') . "</b>";
        }
