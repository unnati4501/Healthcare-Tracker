...
class PersonalChallengeDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if ($isJoined) {
            $returnArray['challengeStartDate'] = Carbon::parse($startDate, config('app.timezone'))->setTimezone($user->timezone)->toAtomString();
            $returnArray['challengeEndDate']   = Carbon::parse($endDate, config('app.timezone'))->setTimezone($user->timezone)->toAtomString();
