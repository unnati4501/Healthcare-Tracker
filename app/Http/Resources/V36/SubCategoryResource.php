    ...
    public function toArray($request)
    {
        ...
        if ($this->id != 0 && $this->id != -1) {
            $category = SubCategory::select('categories.short_name as categoryShortName')->
                ...
                ->first();
            if ($category->categoryShortName == 'course' || $category->categoryShortName == 'webinar' || $category->categoryShortName == 'feed' || $category->categoryShortName == 'meditation' || $category->categoryShortName == 'podcast') {
