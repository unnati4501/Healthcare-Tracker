...
class MasterClassLessonResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'isCompleted' => (!empty($this->userLessonStatus) && $this->userLessonStatus == "completed") ? true : false,
            'isRunning'   => (!empty($this->userLessonStatus) && $this->userLessonStatus == "started") ? true : false,
