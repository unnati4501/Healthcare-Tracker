...
class CoachDetailsByCoachResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $courseData = Course::where("creator_id", $this->id);
        ...
        return [
            ...
            'isFollowing' => (!empty($studentFollowing) && $studentFollowing->followed) ,
            'isReviewed'  => (!empty($studentFollowing) && $studentFollowing->ratings > 0) ,
        ];
    }
}
