...
Tree.prototype.createSearchBar = function (parentNode) {
  ...
  var searchNode = Util.dom.createNode('input', { class: 'search form-control', placeholder: 'Search...' });
...
exports.createSelected = function (astItem, disableRemoval, showSectionOnSelected) {
  ...
  var selectedInputProps = {
    class: 'members-selected',
    type: 'hidden',
    name: 'members_selected[]',
    value: astItem.value
  };
  var inputSelectedNode = exports.createNode('input', selectedInputProps);
  node.appendChild(inputSelectedNode);
