...
@include('admin.group.breadcrumb',[
    'appPageTitle' => trans('group.title.add_form_title'),
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card form-card">
                {{ Form::open(['route' => 'admin.groups.store', 'class' => 'form-horizontal zevo_form_submit', 'method'=>'post','role' => 'form', 'id'=>'groupAdd','files' => true]) }}
                <div class="card-body">
                    @include('admin.group.form', ['edit'=>false])
                </div>
                <div class="card-footer">
                    <div class="save-cancel-wrap">
                        <a class="btn btn-outline-primary" href="{!! route('admin.groups.index') !!}" >{{trans('buttons.general.cancel')}}</a>
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\CreateGroupRequest','#groupAdd') !!}
