<script id="appGraphTemplate" type="text/html">
    <p class="m-0 font-19 text-center">{{trans('customersatisfaction.title.mobile_app_experience_score')}}</p>
...
<script id="appgraphBarTemplate" type="text/html">
...
<script id="appgraphLegendTemplate" type="text/html">
