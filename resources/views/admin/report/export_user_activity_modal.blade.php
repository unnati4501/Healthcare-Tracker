            ...
            <div class="modal-body" id="exportNps">
                ...
                <div class="input-daterange daterangesFromExportModel">
                    <div class="form-group col-lg-12">
                        ...
                        {{ Form::text('start_date', date('Y-m-d'), ['id' => 'start_date_app', 'class' => 'form-control datepicker', 'placeholder' => trans('userregistration.filter.from_date'), 'readonly' => true, 'style'=>'text-align:left']) }}
                    </div>
                    <div class="form-group col-lg-12">
                        {{ Form::label('end_date', trans('challenges.modal.export.form.labels.to_date'),['id' => 'to_date_label']) }}
                        {{ Form::text('end_date', date('Y-m-d'), ['id' => 'start_date_app', 'class' => 'form-control datepicker', 'placeholder' => trans('userregistration.filter.to_date'), 'readonly' => true, 'style'=>'text-align:left']) }}
                    </div>
                </div>
            </div>
