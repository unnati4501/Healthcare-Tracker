<script id="projectgraphTemplate" type="text/html">
    <p class="m-0 font-19 text-center">{{trans('customersatisfaction.title.project_survey_experience_score')}}</p>
...
<script id="projectgraphBarTemplate" type="text/html">
...
<script id="projectgraphLegendTemplate" type="text/html">
