...
@include('admin.webinar.breadcrumb',[
    'mainTitle'  => trans('webinar.title.add_form_title'),
    'breadcrumb' => 'webinar.create',
    'create'     => false,
])
<!-- /.content-header -->
@endsection
...
<section class="content no-default-select2">
    <div class="container-fluid">
        <div class="card form-card">
            {{ Form::open(['route' => 'admin.webinar.store', 'class' => 'form-horizontal zevo_form_submit', 'method'=>'post','role' => 'form', 'id'=>'webinaradd', 'files' => true]) }}
            <div class="card-body">
                @include('admin.webinar.form', ['edit' => false])
            </div>
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\CreateWebinarRequest','#webinaradd') !!}
...
<script src="{{ asset('js/webinar/create.js') }}" type="text/javascript">
</script>
@endsection
