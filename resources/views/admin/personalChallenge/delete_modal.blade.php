        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    @if($planAccess)
                    {{ trans('personalChallenge.modal.title') }}
                    @else
                    {{ trans('personalChallenge.modal.title_goal') }}
                    @endif
                </h5>
            ...
            <div class="modal-body">
                <p>
                    @if($planAccess)
                    {{ trans('personalChallenge.modal.message') }}
                    @else
                    {{ trans('personalChallenge.modal.message_goal') }}
                    @endif
                </p>
            </div>
