...
@include('admin.feed.breadcrumb',[
    'appPageTitle' => trans('feed.title.edit_form_title'),
    'breadcrumb' => 'feed.edit',
    'create'     => false,
    'back'       => false,
    'edit'       => false,
])
...
<section class="content no-default-select2">
    <div class="container-fluid">
        <div class="card form-card">
            {{ Form::open(['route' => ['admin.feeds.update', $id], 'class' => 'form-horizontal zevo_form_submit', 'method'=>'PATCH','role' => 'form', 'id' => 'feedEdit', 'files' => true]) }}
            <div class="card-body">
                @include('admin.feed.form', [ 'edit' => true, 'isSA' => $isSA, 'clone' => ($isCloned ? true : false) ])
                {{ Form::hidden('isCloned', $isCloned ? true : false) }}
            </div>
...
@endif
{!! JsValidator::formRequest('App\Http\Requests\Admin\EditFeedRequest','#feedEdit') !!}
<script type="text/javascript">
    ...
    message = {
        ...
        feed_cannot_remove: '{{ trans('feed.message.feed_cannot_remove') }}',
        upload_image_dimension: '{{ trans('feed.message.upload_image_dimension') }}',
    };
</script>
<script src="{{ asset('js/feed/edit.js') }}" type="text/javascript">
</script>
@endsection
