    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <section class="col-lg-12">
                ...
                <div class="card">
                    <!-- /.card-header -->
                    {{ Form::open(['route' => 'admin.users.changepasswordprocess', 'class' => 'form-horizontal', 'method'=>'post','role' => 'form', 'id'=>'changePassword']) }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-4 offset-xl-1">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-xl-12">
                                        ...
                                        <input autocomplete="off" class="form-control" id="current_password" name="current_password" type="password"/>
                                    </div>                                    
                                    <div class="form-group col-md-6 col-xl-12">
                                        <label for="">
