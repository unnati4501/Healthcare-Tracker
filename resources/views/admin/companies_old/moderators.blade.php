    ...
    <div class="container-fluid">
        <div class="d-md-flex justify-content-between">
            <div class="align-self-center">
                ...
                {{ Breadcrumbs::render('companiesold.moderator.index', $companyType) }}
            </div>
            <div class="align-self-center">
                @permission('add-moderator')
                <a class="btn btn-primary" href="{{ route('admin.companiesold.createModerator', [$companyType, $company->id]) }}">
            ...
            <div class="card-body pb-0">
                ...
                <div class="search-outer d-md-flex justify-content-between">
                    ...
                    <div class="search-actions align-self-start">
                        ...
                        <a class="filter-cancel-icon" href="{{ route('admin.companiesold.moderators', [$companyType, $company->id]) }}">
