    ...
    <div class="container-fluid">
        <div class="d-md-flex justify-content-between">
            <div class="align-self-center">
                ...
                {{ Breadcrumbs::render('companiesold.portalFooter', $companyType, $company->id) }}
            </div>
        </div>
    </div>
</div>
...
<section class="content">
    <div class="container-fluid">
        {{ Form::open(['route' => ['admin.companiesold.storePortalFooterDetails', $companyType, $company->id], 'class' => 'form-horizontal zevo_form_submit', 'method' => 'PATCH', 'role' => 'form', 'id' => 'storePortalFooterDetails', 'files' => true]) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file custom-file-preview">
                                    ...
                                    <label class="file-preview-img" for="portal_footer_logo">
                                        <img height="200" id="portal_footer_logo_preview" src="{{ (!empty($company->portal_footer_logo) ? $company->portal_footer_logo : asset('assets/dist/img/boxed-bg.png')) }}" width="200"/>
                                    </label>                                    
                                    {{ Form::label('portal_footer_logo', (!empty($company->portal_footer_logo) ? $company->portal_footer_logo_name : "Choose File"), ['class' => 'custom-file-label']) }}
                                </div>
                            </div>
                        </div>
                    </div>
