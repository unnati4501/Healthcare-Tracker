    ...
    <div class="container-fluid">
        <div class="d-md-flex justify-content-between">
            <div class="align-self-center">
                ...
                {{ Breadcrumbs::render('companiesold.limits.index', $companyType) }}
            </div>
            <div class="align-self-center">
            ...
            <div class="tab-content" id="limitListContent">
                ...
                <div aria-labelledby="challengepoints" class="tab-pane fade" id="challengepoints" role="tabpanel">
                    <div class="text-end mb-4">
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.companiesold.editLimits', [$companyType, $company->id, 'type' => 'challenge']) }}">
                ...
                <div aria-labelledby="rewardspoints" class="tab-pane fade" id="rewardspoints" role="tabpanel">
                    <div class="text-end mb-4">
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.companiesold.editLimits', [$companyType, $company->id, 'type' => 'reward']) }}">
                            <i class="far fa-edit me-3 align-middle">
                            </i>
                            <span class="align-middle">
                                {{ trans('buttons.general.edit') }}
                ...
                <div aria-labelledby="rewardspointslimit" class="tab-pane fade" id="rewardspointslimit" role="tabpanel">
                    <div class="text-end mb-4">
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.companiesold.editLimits', [$companyType, $company->id, 'type' => 'reward-daily-limit']) }}">
                            <i class="far fa-edit me-3 align-middle">
                            </i>
                            <span class="align-middle">
                                {{ trans('buttons.general.edit') }}
