...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card form-card">
            {{ Form::open(['route' => ['admin.marketplace.confirm-event-booking', $event->id, $eventBookingLogsTemp->id], 'class' => 'form-horizontal book_event_from_submit', 'method' => 'PATCH', 'role' => 'form', 'id' => 'bookEvent']) }}
            <div class="card-body">
                            ...
                            <div class="tab-pane active booking-steps event-details-content" role="tabpanel" id="step-1" data-step="0">
                                    ...
                                    <div class="row justify-content-center justify-content-md-start">
                                        ...
                                        <div class="col-xxl-9 col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6" data-capacity="{{ !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->capacity_log : $event->capacity }}" data-capacity-block="" data-totalusers="0">
                                                    <div class="form-group">
                                                        {{ Form::label(null, trans('marketplace.book_event.form.labels.capacity')) }}
                                                        {{ Form::text('capacity', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->capacity_log : $event->capacity, ['class' => 'form-control', 'id' => 'capacity']) }}
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if($disableCompany)
                                                        {{ Form::select('company', $companies, $company->id, ['class' => 'form-control select2', 'id' => 'company', 'placeholder' => 'Select company', 'data-placeholder' => 'Select company', 'data-disabled' => 'readonly'], $companiesAttr) }}
                                                        @else
                                                        {{ Form::select('company', $companies, !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->company_id : null, ['class' => 'form-control select2', 'id' => 'company', 'placeholder' => 'Select company', 'data-placeholder' => 'Select company', 'data-disabled' => 'readonly'], $companiesAttr) }}
                                                        @endif
                                                    </div>
                                                </div>
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::textarea('description', old('description', (isset($description) ? $description : null)), ['class' => 'form-control article-ckeditor', 'id' => 'description', 'data-errplaceholder' => '#description-error-cstm', 'data-formid' => "bookEvent", 'data-upload-path' => route('admin.ckeditor-upload.feed-description', ['_token' => csrf_token() ])]) }}
                            ...
                            <div class="tab-pane booking-steps registration-details-content" role="tabpanel" id="step-2" data-step="1">
                                <div class="card-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::textarea('notes', old('notes', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->notes : null), ['id' => 'notes', 'rows' => 3, 'class' => 'form-control basic-format-ckeditor ignore-validation', 'placeholder' => 'Enter additional notes']) }}
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::textarea('email_notes', old('email_notes', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->email_notes : null), ['id' => 'email_notes', 'rows' => 3, 'class' => 'form-control basic-format-ckeditor ignore-validation', 'placeholder' => 'Enter email notes']) }}
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-4 form-group">
                                            ...
                                            {{ Form::text('registrationdate', old('registrationdate', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->registration_date : null) , ['class' => 'form-control bg-white', 'placeholder' => 'Select Date and Time', 'id' => 'registrationdate', 'autocomplete' => 'off', 'readonly' => true]) }}
                                        </div>
                                        <div class="col-lg-6 col-xl-8">
                                            @if($showComplementaryOpt)
                                            <label class="custom-checkbox no-label">{{ trans('marketplace.book_event.form.labels.complementary') }}
                                                {{ Form::checkbox('is_complementary', true, old('is_complementary', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->is_complementary : false), ['class' => 'form-control', 'id' => 'is_complementary']) }}
                                            ...
                                            <label class="custom-checkbox no-label">
                                                ...
                                                {{ Form::checkbox('add_to_story', true, old('add_to_story', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->add_to_story : false), ['class' => 'form-control', 'id' => 'add_to_story']) }}
                                                <span class="checkmark">
                                                </span>
                                                <span class="box-line">
                                                </span>
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="owl-carousel owl-theme arrow-theme" id="presenter-owl-carousel">
                                        @if(count($eventPresenters) > 0)
                                            ...
                                            <div class="presenter-item border-0 pe-2">
                                                <div class="presenter-item-top">
                                                    <div class="presenter-top border-0 p-0">
                                                        ...
                                                        <input type="radio" name="ws_user" class="roleGroup pick-presenter form-control" {{ ($presenter_user_id === $presenter->id) ? 'Checked' : '' }} value="{{ $presenter->id }}" videoLink="{{ $presenter->video_link }}" slotId="{{ $presenter->id }}">
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-center">No Available Wellbeing Specialist</p>
                                        @endif
                                    </div>
                                </div>
                                @if(strtolower($locationTypes[$event->location_type]) == strtolower('Online'))
                                 <div class="card-inner">
                                    <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group d-flex {{ (is_null($eventBookingLogsTemp->video_link)) ? 'd-none' : '' }}" id="location_type_section">
                                            <div class="me-3 w-50">
                                                ...
                                                {{ Form::text('video_link', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->video_link : null, ['class' => 'form-control','placeholder' => config('zevolifesettings.video_link_message.placeholder'), 'readonly' => true, 'id' => 'video_link_field']) }}
                                            </div>
                                            ...
                                            {{ Form::hidden('company_type', !empty($eventBookingLogsTemp) ? $eventBookingLogsTemp->company_type : 'Zevo', ['class' => 'form-control', 'id' => 'company_type'] ) }}
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                @endif
                                {{ Form::hidden('action', 'add', ['id' => 'action', 'class' => 'form-control']) }}
