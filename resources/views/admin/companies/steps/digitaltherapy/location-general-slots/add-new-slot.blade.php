<div class="d-flex align-items-center add-new-slot-block-location">
    <div class="set-availability-date-time d-flex slot-control-block-location flex-grow-1">
        <div class="set-availability-inner">
            {{ Form::text('slot_start_time', null, ['class' => 'locationtime start form-control', 'autocomplete' => "off"]) }}
        </div>
        <div class="set-availability-inner">
            {{ Form::text('slot_end_time', null, ['class' => 'locationtime end form-control', 'autocomplete' => "off"]) }}
        </div>
    ...
    <div class="d-flex set-availability-btn-area justify-content-end slot-action-block-location">
        <a class="edit-slot-location action-icon me-3 ms-3 save-new-slot-location" href="javascript:void(0);" title="Add Slot">
            <i class="far fa-save">
            </i>
        </a>
        <a class="delete-slot-location action-icon danger close-add-new-slot-location" href="javascript:void(0);" title="Cancel">
