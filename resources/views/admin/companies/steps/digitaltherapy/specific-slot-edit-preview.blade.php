<div class="d-flex align-items-center specific-edit-slot-block p-2" data-id="{{ $id }}">
    ...
    <div class="d-flex set-availability-btn-area justify-content-end slot-action-block">
        <a class="edit-slot action-icon me-3 ms-3 save-specific-edit-slot" href="javascript:void(0);" title="Save Slot">
            <i class="far fa-save">
            </i>
        </a>
        <a class="delete-slot action-icon danger cancel-specific-edit-slot" href="javascript:void(0);" title="Cancel">
