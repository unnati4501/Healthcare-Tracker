    ...
    <div class="container-fluid">
        <div class="d-md-flex justify-content-between">
            <div class="align-self-center">
                ...
                {{ Breadcrumbs::render('companies.app-settings.index') }}
            </div>
            <div class="align-self-center">
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end mb-10">
                    ...
                    @endif
                    <a class="btn btn-primary" href="{{ route('admin.companies.changeAppSettingCreateEdit', [$companyType, $company->id]) }}">
                        <i class="far fa-cogs me-3 align-middle">
                        </i>
                        <span class="align-middle">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{ route('admin.companies.changeToDefaultSettings', [$companyType,request()->company]) }}" id="defaultSettings-model-box-confirm">
                    Yes
                </a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#AppSettingsManagment').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('admin.companies.getCompanyAppSettings','zevo') }}',
                data: {
                    company: {{ $company->id }},
