    ...
    <div class="container-fluid">
        <div class="d-md-flex justify-content-between">
            <div class="align-self-center">
                ...
                {{ Breadcrumbs::render('companies.app-settings.update', $companyType ,request()->company) }}
            </div>
        </div>
    </div>
</div>
...
<section class="content">
    <div class="container-fluid">
        <div class="card form-card">
            {{ Form::open(['route' => 'admin.companies.changeAppSettingStoreUpdate', 'class' => 'form-horizontal', 'method' => 'post', 'role' => 'form', 'id' => 'changeAppSettings', 'files' => true]) }}
            <div class="card-body">
            ...
            <div class="card-footer">
                <div class="save-cancel-wrap">
                    <a class="btn btn-outline-primary" href="{{ route('admin.companies.changeAppSettingIndex' ,[$companyType, request()->company]) }}">
