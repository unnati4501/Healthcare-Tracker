...
@include('admin.zcsurvey.breadcrumb', [
    'mainTitle' => trans('survey.title.add'),
    'breadcrumb' => Breadcrumbs::render('survey.create'),
    'back' => false
])
<!-- /.content-header -->
@endsection
        ...
        <div class="card form-card height-auto">
            <div class="wizard">
                <div class="wizard-inner">
                    {{ Form::open(['route' => 'admin.zcsurvey.store', 'class' => 'form-horizontal', 'method' => 'post', 'role' => 'form', 'id' => 'surveyAdd']) }}
                    @include('admin.zcsurvey.form', ['edit' => false])
                    {{ Form::close() }}
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="m-0" id="err-box-message">
...
{!! $validator = JsValidator::formRequest('App\Http\Requests\Admin\CreateZCSurveyRequest', '#surveyAdd') !!}
...
<script src="{{ mix('js/zcsurvey/zcSurveyCreate.js') }}">
</script>
@endsection
