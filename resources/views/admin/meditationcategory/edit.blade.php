...
@section('content')
@include('admin.meditationcategory.breadcrumb',['appPageTitle'=>trans('labels.meditationcategory.edit_form_title')])
        ...
        <div class="container-fluid">
            ...
            <!-- Left col -->
                ...
                <!-- DIRECT CHAT -->
                    <div class="card">
                      <!-- /.card-header -->
                        {{ Form::open(['route' => ['admin.meditationcategorys.update',$id], 'class' => 'form-horizontal', 'method'=>'PATCH','role' => 'form', 'id'=>'meditationcategoryEdit','files' => true]) }}
                        <div class="card-body">
                                <div class="row">
                      ...
                      <!-- /.card-body -->
                        <div class="card-footer border-top text-center">
                            ...
                            <button type="submit" class="btn btn-primary btn-effect mm-w-100">{{trans('labels.buttons.update')}}</button>
                        </div>
                      {{ Form::close() }}
                      <!-- /.card-footer-->
                    </div>
...
@section('after-scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\EditMeditationCatRequest','#meditationcategoryEdit') !!}
