        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    {{ trans('podcast.modal.delete.title') }}
                </h5>
            ...
            <div class="modal-body">
                <p>
                    {{ trans('podcast.modal.delete.message') }}
                </p>
            </div>
...
<div class="modal fade" data-id="0" id="company_visibility_preview" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    {{ trans('podcast.modal.visible_company.title') }}
                </h5>
                <button aria-label="Close" class="close" data-bs-dismiss="modal" type="button">
                    <i class="fal fa-times">
                    </i>
                ...
                <div class="table-responsive">
                    <table class="table custom-table" id="visible_to_company_tbl">
                        <thead>
                            <tr>
                                <th>
                                    {{ trans('podcast.visible_company_tbl.no') }}
                                </th>
                                <th>
                                    {{ trans('podcast.visible_company_tbl.group_type') }}
                                </th>
                                <th>
                                    {{ trans('podcast.visible_company_tbl.company') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody>
