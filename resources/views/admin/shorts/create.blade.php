...
@include('admin.shorts.breadcrumb', [
    'mainTitle' => trans('shorts.title.add'),
    'breadcrumb' => Breadcrumbs::render('shorts.create'),
])
<!-- /.content-header -->
@endsection
...
<section class="content no-default-select2">
    <div class="container-fluid">
        <div class="card form-card">
            {{ Form::open(['route' => 'admin.shorts.store', 'class' => 'form-horizontal zevo_form_submit', 'method' => 'post', 'role' => 'form', 'id' => 'shortsAdd', 'files' => true]) }}
            <div class="card-body">
                @include('admin.shorts.form', ['edit' => false])
            </div>
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\CreateShortsRequest','#shortsAdd') !!}
...
<script type="text/javascript">
    ...
    function formSubmit() {
        ...
        var selectedMembers = $('#shorts_company').val().length;
...
<script src="{{ mix('js/shorts/create.js') }}" type="text/javascript">
</script>
@endsection
