...
@include('admin.surveycategories.surveysubcategories.breadcrumb', [
    'mainTitle' => trans('surveysubcategories.title.edit', [
        'category' => request()->surveycategory->display_name,
    ]),
    'breadcrumb' => Breadcrumbs::render('surveysubcategories.edit', request()->surveycategory->id),
])
<!-- /.content-header -->
@endsection
...
<section class="content">
    <div class="container-fluid">
        {{ Form::open(['route' => ['admin.surveysubcategories.update', $categoryId, $id], 'class' => 'form-horizontal', 'method' => 'PATCH', 'role' => 'form', 'id' => 'subCategoryEdit', 'files' => true]) }}
        <div class="card form-card">
            <div class="card-body">
                @include('admin.surveycategories.surveysubcategories.form', ['edit' => true])
            </div>
            <div class="card-footer">
                <div class="save-cancel-wrap">
                    <a class="btn btn-outline-primary" href="{{ route('admin.surveysubcategories.index', $categoryId) }}">
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\EditSurveySubCategoryRequest', '#subCategoryEdit') !!}
...
<script src="{{ mix('js/surveysubcategories/edit.js') }}" type="text/javascript">
</script>
@endsection
