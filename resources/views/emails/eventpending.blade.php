                            ...
                            <td style="padding-top:70px;padding-left: 15px;padding-right: 15px;">
                                <p style="margin: 0;line-height: 1.4;font-size: 18px;color: #333333;">
                                    @if($type == "presenter")
                                        ...
                                        Hi {{$presenter}},<br/><br/>
                                        @endif
                                        You have received a booking for {{ $eventName }} with {{ $companyName }}. This is scheduled for {{ $eventStartDate }} at {{$eventStartTime}}.
                                        <br/><br/>
                                        Please click Accept or Reject below. The Zevo team will be notified.
                                    @endif
                                </p>
                            </td>
                        </tr>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <!--[if mso]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{!! $eventAcceptUrl !!}" style="width:260px;height:42px;v-text-anchor:middle;max-width:260px;min-width:260px;" arcsize="63%" stroke="f" fillcolor="#5261AC">
                                                    <v:textbox inset="0,0,0,0">
                                                  <w:anchorlock/>
                                                  <center>
                                                <![endif]-->
                                                <a href="{!! $eventAcceptUrl !!}"
                                                style="color:#ffffff;display:block;font-family:sans-serif;font-size:13px;font-weight:400;line-height:40px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;background-color:#5261AC;border-radius:25px;width:260px;height:40px;min-height:40px;min-width:260px;max-width: 260px;max-height: 40px;margin:0 auto;" class="template-btn" title="Accept">Accept</a>
                                            ...
                                            <td>
                                                <!--[if mso]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{!! $eventRejectUrl !!}" style="width:260px;height:42px;v-text-anchor:middle;max-width:260px;min-width:260px;" arcsize="63%" stroke="f" fillcolor="#5261AC">
                                                    <v:textbox inset="0,0,0,0">
                                                  <w:anchorlock/>
                                                  <center>
                                                <![endif]-->
                
                                                <a href="{!! $eventRejectUrl !!}"
                                                style="color:#ffffff;display:block;font-family:sans-serif;font-size:13px;font-weight:400;line-height:40px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;background-color:#5261AC;border-radius:25px;width:260px;height:40px;min-height:40px;min-width:260px;max-width: 260px;max-height: 40px;margin:0 auto;" class="template-btn" title="Reject">Reject</a>
