                    ...
                    <tr align="center" style="border-collapse:collapse;text-align: center">
                            <td style="padding-top:70px;padding-left: 15px;padding-right: 15px;">
                                <p style="margin: 0;line-height: 1.4;font-size: 18px;color: #333333;">
                                     Hi,<br/><br/>An error occured in the Digital Therapy {{ $type }} flow. Please find the details below.
                                     <br/>
                                     <br/>
                                     Wellbeing Specialist Name: <strong>{{ $wsName }}</strong>
                                     <br/>
                                     @if($userName)
                                     ...
                                     <br/>
                                     Error Message: <strong>{{ $description }}</strong>
                                </p>
                            </td>
                        </tr>
                        @if(!empty($errorDetails))
                        <tr>
                            <td><br/><br/><code>{!! $errorDetails !!}</code></td>
                        </tr>
                        @endif
                        <tr>
