                            ...
                            <td style="padding-top:70px;padding-left: 15px;padding-right: 15px;">
                                <p style="margin: 0;line-height: 1.4;font-size: 18px;color: #333333;">
                                    @if($type == "presenter")
                                        ...
                                        Hi {{$presenter}},<br/><br/>
                                        @endif
                                        The booking for {{ $eventName }} with {{ $companyName }} which was  scheduled for {{ $eventStartDate }} at {{$eventStartTime}} has expired. No further action is required.  
                                        <br/><br/>
                                        For more information contact the Zevo Health team.
                                    @endif
                                </p>
                            </td>
                        </tr>
