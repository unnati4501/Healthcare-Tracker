...
$(document).ready(function() {
    ...
    $('#shortsEdit').ajaxForm({
        beforeSend: function() {
            ...
            $('#shortsEdit .card-footer button, #shortsEdit .card-footer a').attr('disabled', 'disabled');
            var percentVal = '0%';
        ...
        success: function(data) {
            ...
            $('#shortsEdit .card-footer button, #shortsEdit .card-footer a').removeAttr('disabled');
            var percentVal = '100%';
            bar.width(percentVal)
            percent.html(percentVal);
    ...
    var _trackType = $('#shorts_type').val(),
    duration_readonly = true;
    if(_trackType != "") {
