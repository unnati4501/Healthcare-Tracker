$(document).ready(function() {
    $('#notificationManagment').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: url.datatable,
    ...
    $(document).on('click', '#notificationDelete', function (t) {
    ...
    $(document).on('click', '#delete-model-box-confirm', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#notificationManagment').DataTable().ajax.reload(null, false);
                if (data['deleted'] == 'true') {
                    toastr.success(message.notification_deleted);
                } else if(data['deleted'] == 'use') {
                    toastr.error(message.notification_in_use);
                } else {
