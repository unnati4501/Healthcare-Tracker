$(document).ready(function() {
    ...
    $('#webinaradd').ajaxForm({
        beforeSend: function() {
            ...
            $('#webinaradd .card-footer button, #webinaradd .card-footer a').attr('disabled', 'disabled');
            var percentVal = '0%';
        ...
        success: function(data) {
            ...
            $('#webinaradd .card-footer button, #webinaradd .card-footer a').removeAttr('disabled');
            var percentVal = '100%';
            bar.width(percentVal)
            percent.html(percentVal);
    ...
    $("select#webinar_companys").treeMultiselect({
