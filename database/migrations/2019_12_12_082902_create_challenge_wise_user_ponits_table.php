...
class CreateChallengeWiseUserPonitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('challenge_wise_user_ponits', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('challenge_wise_user_ponits');
