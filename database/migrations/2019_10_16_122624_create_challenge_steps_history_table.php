...
class CreateChallengeStepsHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('challenge_steps_history', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('challenge_steps_history');
