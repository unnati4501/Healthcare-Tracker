...
class CreateChallengeParticipantStatusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('challenge_participant_status', function (Blueprint $table) {
            ...
            $table->string('status', 255)->default('Pending')->comment('specifies status of invitee/joinee for the respective challenge');
