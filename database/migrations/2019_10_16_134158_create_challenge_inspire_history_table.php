...
class CreateChallengeInspireHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('challenge_inspire_history', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('challenge_inspire_history');
