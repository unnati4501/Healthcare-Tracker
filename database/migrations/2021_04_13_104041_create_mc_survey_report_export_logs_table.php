...
class CreateMcSurveyReportExportLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mc_survey_report_export_logs', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('mc_survey_report_export_logs');
