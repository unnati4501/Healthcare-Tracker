...
class CreateUserIncompletedTracksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_incompleted_tracks', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('user_incompleted_tracks');
