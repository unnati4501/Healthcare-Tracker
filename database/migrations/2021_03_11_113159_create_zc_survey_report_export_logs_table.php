...
class CreateZcSurveyReportExportLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('zc_survey_report_export_logs', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('zc_survey_report_export_logs');
