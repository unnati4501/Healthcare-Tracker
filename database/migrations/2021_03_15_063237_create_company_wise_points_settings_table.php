...
class CreateCompanyWisePointsSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_wise_points_settings', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('company_wise_points_settings');
